...
// Ops
const (
	Create WatchEvent = WatchEvent(watcher.Create)
	Write  WatchEvent = WatchEvent(watcher.Write)
	Remove WatchEvent = WatchEvent(watcher.Remove)
	Rename WatchEvent = WatchEvent(watcher.Rename)
	Chmod  WatchEvent = WatchEvent(watcher.Chmod)
	Move   WatchEvent = WatchEvent(watcher.Move)
)
