...
func updateFSCounters(ctx *fasthttp.RequestCtx, logger logz2.Logger) {
	...
	case fasthttp.StatusNotFound:
		...
		logger.Erro(errors.New("File/Directory " + ctx.Request.URI().String() + " request failed, path not found"))
	default:
