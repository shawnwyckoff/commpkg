...
func handleMux(conn net.Conn, config *ServerOption, lg glogger.Logger) {
...
func handleClient(p1 io.ReadWriteCloser, p2 net.Conn, lg glogger.Logger) {
	defer p1.Close()
	defer p2.Close()
...
func ServeWait(l glistener.Listener, lg glogger.Logger, config ServerOption) error {
