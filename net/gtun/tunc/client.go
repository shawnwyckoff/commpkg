...
import (
	...
	"github.com/shawnwyckoff/gopkg/net/gdialer"
...
func handleClient(muxer gmux.Mux, p1 net.Conn, lg glogger.Logger) {
	defer p1.Close()
	p2, err := muxer.Open()
	if err != nil {
		lg.Erro(err)
...
func scavenger(ch chan gmux.Mux, ttl int, lg glogger.Logger) {
